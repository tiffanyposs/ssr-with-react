  ...
  _createClass(UsersListPage, [{
    ...
    value: function head() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('meta', { property: 'og:title', content: 'User\'s App' })
      );
    }
  }, {
    key: 'render',
...
exports.default = function (req) {
  ...
  var store = (0, _redux.createStore)(_reducers2.default, {}, (0, _redux.applyMiddleware)(_reduxThunk2.default.withExtraArgument(axiosInstance)) // pass axios instance to thunk
  );
  return store;
};
